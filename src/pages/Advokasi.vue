...
import AdvokasiComponent from "../component/AdvokasiComponent.vue";
...
<template>
    ...
    <div class="bg-black/75 h-full flex flex-col my-auto justify-center">
      ...
      <div class="text-holy text-center my-4">
        ...
        <p
          ...
          class="text-md"
        >
          Layanan pendampingan, penanganan keluhan, dan penyaluran aspirasi Mahasiswa IT.
        </p>

        <!-- Button Panah Bulat Red/Cosmos Bounce -->
        <div
          v-motion
          :initial="{ opacity: 0, y: 100 }"
          :visibleOnce="{
        ...
        >
          ...
          <a href="#Advokasi" aria-label="Scroll Down">
  ...
  <!-- Body Section -->
  <section id="Advokasi" class="w-full h-full lg:pb-[140px] py-5 bg-gradient-to-r from-errie to-charcoal">
    <AdvokasiComponent />
  </section>
